...
export default defineEventHandler(async (event) => {
  ...
  const appStoreSuggestions: {
    ...
    (e: { trackName: string; trackViewUrl: string; description: string }) => {
      return {
        title: e.trackName,
        url: e.trackViewUrl,
  ...
  return { googlePlay: googlePlaySuggestions, appStore: appStoreSuggestions };
});
